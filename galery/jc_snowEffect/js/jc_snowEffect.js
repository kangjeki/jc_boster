/* --------------------------------------------------------------------------------------------------/
	Project 	: Snow Effect;
	Created 	: Imam Nasrudin (JC Programs);
	JS.v 	 	: ES5 Up
----------------------------------------------------------------------------------------------------*/
(function() {
	...
	const 	divFrame 	= $.createElement('div');
			...
			divFrame.style.cssText = "z-index: -1; margin:0; padding:0; overflow:hidden; width: 100%; position: fixed; top:0; left:0; bottom:0; right:0;";
	...
	function Animate() {
		...
		bugSnow.forEach(function(snw) {
			...
			if (snw.t <= (_iH - 5) ) {
				snw.l += 2.5;				// Sisi Sapuan Aangin / kemiringan snow jatuh	
